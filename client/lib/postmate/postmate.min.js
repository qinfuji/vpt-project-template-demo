      ...
      return (
        (t.get = function(e) {
          ...
          return new m.Promise(function(n) {
            ...
            a.parent.addEventListener(
              ...
              a.child.postMessage(
                { postmate: "request", type: p, property: e, uid: i },
                a.childOrigin
              );
          });
        }),
        (t.call = function(e, t) {
          this.child.postMessage(
            { postmate: "call", type: p, property: e, data: t },
            this.childOrigin
          );
        }),
        (t.on = function(e, t) {
          ...
          this.child.addEventListener("message", function(t) {
            if (l(t, d.parentOrigin)) {
              ...
              if ("call" !== t.data.postmate)
                ...
                m.Promise.resolve(i)).then(function(e) {
      ...
      return (
        (e.prototype.emit = function(e, t) {
          this.parent.postMessage(
            { postmate: "emit", type: p, value: { name: e, data: t } },
            this.parentOrigin
          );
        }),
        e
        ...
        (e.prototype.sendHandshake = function(a) {
          ...
          return new e.Promise(function(n, i) {
            ...
            var e = function() {
                d++,
                  o.child.postMessage(
                    { postmate: "handshake", type: p, model: o.model },
                    s
                  ),
                  5 === d && clearInterval(r);
              },
    ...
    (m.Model = (function() {
      ...
      return (
        (e.prototype.sendHandshakeReply = function() {
          var s = this;
          return new m.Promise(function(r, o) {
            s.child.addEventListener(
              "message",
              function e(t) {
                if (t.data.postmate) {
                  if ("handshake" === t.data.postmate) {
                    s.child.removeEventListener("message", e, !1),
                      t.source.postMessage(
                        { postmate: "handshake-reply", type: p },
                        t.origin
                      ),
                      (s.parentOrigin = t.origin);
                    var n = t.data.model;
                    if (n)
                      for (var i = Object.keys(n), a = 0; a < i.length; a++)
                        d.call(n, i[a]) && (s.model[i[a]] = n[i[a]]);
                    return r(new c(s));
                  }
