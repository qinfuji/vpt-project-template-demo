...
export const entryTarget = {
  drop: (props, monitor, component) => {
    console.log('drop---->', props._editInfo);
    //return {};
    return undefined;
  },
  ...
  hover: (props, monitor, component) => {
    if (monitor.canDrop()) {
      ...
      const dropDomElement = ReactDOM.findDOMNode(component);
      const rects = dropDomElement.getBoundingClientRect(); //获取当前drop的rect
      //如果drag的位置在drop的rect中，则不显示
      const gragItemInitPosition = monitor.getInitialSourceClientOffset();
